...
<a href="{{ route('content.show', $service->slug) }}"
   data-reveal
   class="group flex flex-col rounded-2xl border border-brand-100 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-brand-300 hover:shadow-lg">
